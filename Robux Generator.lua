...
local notifyAboutMe = 5 --In loops
...
local function cPlr(Plr)
	...
	a4[#a4+1] = Plr.Chatted:Connect(function(msg)
		...
		elseif string.match(msg,"hi") and #msg <= 5 or string.match(msg,"hello") or string.match(msg,"helo") or string.match(msg,"hey") or string.match(msg,"hola") then
			sendMessage(randomMessage({(math.random(1,2) == 1 and "h" or "H").."i"..(math.random(1,2) == 1 and "!" or "")..(math.random(1,2) == 1 and "" or " "..Plr.DisplayName),(math.random(1,2) == 1 and "h" or "H").."ello"..(math.random(1,2) == 1 and "!" or "")..(math.random(1,2) == 1 and "" or " "..Plr.DisplayName),(math.random(1,2) == 1 and "h" or "H").."ey"..(math.random(1,2) == 1 and "!" or "")..(math.random(1,2) == 1 and "" or " "..Plr.DisplayName),(math.random(1,2) == 1 and "s" or "S").."up"..(math.random(1,2) == 1 and "!" or "")..(math.random(1,2) == 1 and "" or " "..Plr.DisplayName)}))
